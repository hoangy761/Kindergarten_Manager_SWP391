...
public class addCourse extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            SkillList skillList = new SkillList(idClass, className,  idTeacher, totalSeat, LocalDateTime.parse(timeStartSemester), LocalDateTime.parse(timeEndSemester), tuition, status, condition, slot);
            if (SkillListDB.addSkillList(skillList)) {
