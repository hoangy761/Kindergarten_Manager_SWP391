...
public class addClass extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ClassList classList = new ClassList(idClass, className, idTeacher, totalSeat, LocalDateTime.parse(timeStartSemester), LocalDateTime.parse(timeEndSemester), tuition, status, condition, "Allday");
