 ...
 * @author PC
 */
public class Analys extends HttpServlet {
     ...
     */
    public static final String SUCCESS = "dashboard.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ChildDB cDb = new ChildDB();
        List<Child> ListChild = cDb.getAllChild();
        
        List<Users> listUser = UsersDB.getAllUsersAnalys();
        
        List<Users> listTeacher = UsersDB.getAllUsers();
