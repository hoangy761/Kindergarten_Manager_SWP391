 ...
 * @author PC
 */
public class GetAllProposal extends HttpServlet {
     ...
     */
    public static final String ERROR = "proposal.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ProposalDB.checkTimeEnd(listProposal);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(GetAllProposal.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
