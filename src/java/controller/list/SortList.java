    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (cond) {
            case "all":
                ...
                break;
            case "03":
                cl = c.getAllClassByConditionClass(cond);
                sl = s.getAllSkillByCondition(cond);
                break;
            case "04":
                cl = c.getAllClassByConditionClass(cond);
                sl = s.getAllSkillByCondition(cond);
            ...
            case "06":
                ...
                break;
            case "0":
                cl = c.getAllClassByTotalSeatClassFull(cond);
                sl = s.getAllSkillByTotalSeatFull(cond);
                break;
                 case "avai":
                cl = c.getAllClassByTotalSeatClass();
                sl = s.getAllSkillByTotalSeat();
                break;
            default:
                cl = c.getAllClassByDateClass();
                sl = s.getAllSkillByDate();
        }
        if (cond.equals("all")) {
