 ...
 * @author ASUS-PRO
 */
public class registerCousre extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String idSkill = request.getParameter("idSkill").trim();
        String idUser = request.getParameter("idUser");
        SkillListDB skillList = new SkillListDB();

        if (!idChild.isEmpty() && !idSkill.isEmpty()) {
            skillList.regisClas(Validator.createID(), idChild, idSkill, "Regist    ");
