...
import static controller.file.FileUpLoadChild.ERORR;
import static controller.file.FileUpLoadChild.SUCCESS;
...
public class FileUploadDob extends HttpServlet {
     ...
     */
    public static final String SUCCESS = "ProfileChildById?idChild=";
    public static final String ERORR = "ProfileChildById?idChild=";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (fileName.isEmpty() && !(fileName.endsWith(".jpg") || fileName.endsWith(".png"))) {
            ...
            request.getRequestDispatcher(ERORR+id).forward(request, response);

        } else {
            for (Part part : request.getParts()) {
                part.write(LinkImg.pathImg() + fileName);

            }
            Path source = Paths.get(LinkImg.pathImg() + fileName);
            ...
            request.getRequestDispatcher(response.encodeURL(SUCCESS+id)).forward(request, response);
        }
    }
