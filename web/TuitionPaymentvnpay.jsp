                    ...
                    <div class="row ">
                        <div class="col-lg-5 col-md-6 mb-5">
                            <div class="card border-0 bg-light shadow-sm pb-2">
                                <div class="card-footer bg-transparent py-4 px-5">
                                    ...
                                    <div class="row border-bottom">
                                        <div class="col-6 py-1 text-right border-right"><strong>Total Fees</strong></div>
                                        <div class="col-6 py-1">${tuition.tuition}$</div>
                                    </div>
                                    <div class="row border-bottom">
                                        <div class="col-6 py-1 text-right border-right"><strong>Start Date</strong></div>
                                        <div class="col-6 py-1">${childClass.getStartDate2()}</div>
                                    </div>
                                    <div class="row border-bottom">
                                        <div class="col-6 py-1 text-right border-right"><strong>End Date</strong></div>
                                        <div class="col-6 py-1">${childClass.getEndDate2()}</div>
                                    </div>
                                </div>
                        ...
                        <div class="container col-md-6 ">
                            ...
                            <div class="form-group">
                                <button onclick="pay()">Payment Transaction</button><br>
                            </div>
                            <div class="form-group">
                                <button onclick="querydr()">Payment Result Query API</button><br>
                            </div>
                            <div class="form-group">
                                <button onclick="refund()">Transaction Refund API</button><br>
                            </div>
                            <p>
                                &nbsp;
                            </p>
